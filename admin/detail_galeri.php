                        ...
                        <div class="card shadow mb-3">
                            ...
                            if(isset($_GET['id'])) {
                                ...
                                while ($row = mysqli_fetch_array($datafoto)){
                                    ?>
                                    <div class="col-md-3"> <!-- Menggunakan kolom lebar md-3 (25% width) untuk setiap foto -->
                                        <div class="card mb-3"> <!-- Tambahkan margin bawah (mb-3) pada setiap card -->
                                            <img src="img/<?php echo $row['file'] ?>" class="img-thumbnail" style="height:100px" alt="<?php echo $row['galery_id']; ?>">
