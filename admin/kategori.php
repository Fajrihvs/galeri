                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                <button type="button" class="btn btn-primary btn-md mb-3" data-toggle="modal" data-target="#katModal">
                                +Tambah kategori
                                </button> 
                                    <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="edit_kategori.php?id=<?php echo $d['id']; ?>" class="btn btn-warning btn-md mx-2 mb-3">
                                                <i class="fas fa-edit"></i>
                                                </a>
                                            <a href="kategori_hapus.php?id=<?php echo $d['id']; ?>" class="btn btn-danger btn-md mb-3" onclick="return confirm('Apakah anda yakin ingin menghapus?')">
